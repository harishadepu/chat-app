  ...
  return (
    selectedUser &&(
        <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
            ...
            <button onClick={()=>logout()} className='absolute bottom-5 left-1/2 transform -translate-x-1/2  bg-gradient-to-r from-purple-400 to-violet-600 border-none text-sm font-light  px-20 py-2 rounded-full cursor-pointer'>Logout</button>
       </div>
    )
